...
Button(root, text='空间域水印', command=create_LSB).place(height=60, width=100, x=100, y=170)
Button(root, text='变换域水印', command=create_DCT).place(height=60, width=100, x=250, y=170)
Button(root, text='新功能按钮', command=create_DCT).place(height=60, width=100, x=400, y=170)

Message(root, text='空间域水印包含:\n    LSB水印嵌入和提取\n    LSB算法改进\n    图像降级算法及其改进', cursor='heart', width='200').place(x=100,
                                                                                                               y=270,
                                                                                                               width=150)
Message(root, text='变换域水印包含:\n    DCT隐写\n    DCT提取', cursor='heart', width='200').place(x=250, y=270, width=150)

Message(root, text='新功能:\n    描述1\n   描述2\n', cursor='heart', width='200').place(x=400, y=270, width=150)
